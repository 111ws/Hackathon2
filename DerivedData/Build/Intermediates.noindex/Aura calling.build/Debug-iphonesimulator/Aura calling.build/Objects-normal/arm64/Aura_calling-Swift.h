...
#ifndef AURA_CALLING_SWIFT_H
#define AURA_CALLING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Aura_calling",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class AVAudioPlayer;
SWIFT_CLASS("_TtC12Aura_calling19AudioPlayerDelegate")
...
@class PKPushPayload;
SWIFT_CLASS("_TtC12Aura_calling14CallKitManager")
...
SWIFT_CLASS("_TtC12Aura_calling20PhotoCaptureDelegate")
